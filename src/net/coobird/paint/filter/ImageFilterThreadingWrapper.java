...
/* TODO Consider using ExecutorCompletionService
 * Returns the completed tasks in a queue, and waits if none are ready.
 * This may be able to reduce the wait time compared to the current
 * implementation of waiting for the first Future.get to work.
 * (Should allow better utilization of CPU.) 
 * 
 */
